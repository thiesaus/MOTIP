...
import copy
import json
import data.refer_kitti_transforms as T
...
class DetMOTDetection:
    def __init__(self, args, data_txt_path: str, seqs_folder, dataset2transform):
        ...
        self.num_frames_per_batch = max(args['SAMPLE_LENGTHS'])
        ...
        # video sampler.
        self.sampler_steps: list = args['SAMPLE_STEPS']
        self.lengths: list = args['SAMPLE_LENGTHS']
